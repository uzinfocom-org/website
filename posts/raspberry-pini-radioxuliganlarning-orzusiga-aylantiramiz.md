...
Raspberry linux yadrosi asosida ishlaydi. Biz esa /dev/mem va mmap yordamida 0x20000000 manziliga periferik shinani virtualizatsiya qilamiz ( _Linuxda /dev/mem asosan periferik qurilmalar bilan bog'liq kiritish va chiqarish xotira manzillariga yo'l sifatida ishlatiladi_ ). Shundan so'ng raspberryda taktotali generator ishga tushib GPIO4 portiga chiqish uchun o'rnatiladi.
